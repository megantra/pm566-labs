...
```
    ...
    ##     fun1() 349.183 575.2405 1099.24089 755.4070 1180.6265 4781.962   100
    ##  fun1alt()  21.513  25.9265   77.43313  32.5685   45.3985 3256.205   100
...
```
    ...
    ## Unit: microseconds
    ##        expr      min       lq      mean    median       uq       max neval
    ##     fun2(x) 1168.206 1312.615 2147.9000 1862.2100 2529.019 10354.308   100
    ##  fun2alt(x)  114.735  177.892  284.2665  231.4455  290.169  4670.703   100
