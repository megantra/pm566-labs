...
\##Step 2 Check the dimensions, headers, footers. How many columns, rows
are there?
...
![](Lab-_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->

``` r
hist(met$temp)
```

![](Lab-_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->

``` r
hist(met$wind.sp) 
```

![](Lab-_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
![](Lab-_files/figure-gfm/unnamed-chunk-20-1.png)<!-- -->
...
![](Lab-_files/figure-gfm/unnamed-chunk-23-1.png)<!-- -->
...
![](Lab-_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
